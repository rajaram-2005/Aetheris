...
import { predictNext } from "@/core/learning/predictions";
import { detectChannel } from "@/core/anomaly/detector";
import { runArena } from "@/core/arena/compare";
import { fftSpectrum } from "@/core/diagnostics/fft";
...
async function pickTwin(uid: string, twinId: string | undefined, demo: boolean) {
  ...
  if (demo) {
    ...
    const { canonicalTurbineTwin } = await import("@/core/windturbine/model");
