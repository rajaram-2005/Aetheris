...
import { runInLab, type LabLanguage, type LabRequest, type LabResult } from "@/core/lab/codesandbox";
import { DEFAULT_GRANTS, type Principal } from "@/core/policy/permissions";
