...
const hi: Partial<Record<Key, string>> = {
  "mode.home": "होम", "mode.chat": "चैट", "mode.characters": "पात्र", "mode.agents": "एजेंट", "mode.factory": "कोडिंग फ़ैक्टरी", "mode.studio": "स्टूडियो", "mode.apps": "ऐप्स", "mode.providers": "प्रोवाइडर", "mode.gallery": "गैलरी", "mode.workflows": "वर्कफ़्लो", "mode.learn": "सीखें", "mode.study": "अध्ययन", "mode.docs": "दस्तावेज़", "mode.schedules": "शेड्यूल", "mode.control": "कंट्रोल सेंटर",
