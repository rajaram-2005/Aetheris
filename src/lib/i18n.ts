...
const en = {
  "mode.chat": "Chat", "mode.characters": "Characters", "mode.agents": "Agents", "mode.factory": "Coding Factory", "mode.studio": "Studio", "mode.apps": "Apps", "mode.providers": "Providers", "mode.gallery": "Gallery", "mode.workflows": "Workflows", "mode.learn": "Learn", "mode.study": "Study", "mode.docs": "Docs", "mode.schedules": "Schedules", "mode.control": "Control Center",
  "sb.newChat": "New chat", "sb.search": "Search chats…", "sb.settings": "⚙ Settings, memory & keys", "sb.signIn": "👤 Enter your name", "sb.signOut": "sign out", "sb.projects": "Projects",
  ...
  "login.title": "Welcome to Aetheris", "login.sub": "Enter your name to continue.", "login.google": "Continue with Google", "login.github": "Continue with GitHub",
  "login.email": "Email", "login.phone": "Phone", "login.sendEmail": "Send code by email", "login.sendSms": "Send code by SMS", "login.sending": "Sending…", "login.code": "6-digit code", "login.name": "Your name (optional)", "login.signIn": "Sign in", "login.verifying": "Verifying…", "login.guest": "Continue as guest →", "login.required": "Sign-in is required to keep your characters, chats, and account data private.", "login.or": "or", "login.orGuest": "or continue as a guest", "login.guestPrompt": "What should we call you?", "login.guestPlaceholder": "Your name", "login.continueGuest": "Continue as guest", "login.starting": "Starting…", "login.guestNote": "Guest data stays in this browser.", "login.change": "change",
...
const ta: Partial<Record<Key, string>> = {
  "mode.chat": "அரட்டை", "mode.characters": "பாத்திரங்கள்", "mode.agents": "ஏஜென்ட்கள்", "mode.factory": "கோடிங் தொழிற்சாலை", "mode.studio": "ஸ்டுடியோ", "mode.apps": "ஆப்ஸ்", "mode.providers": "வழங்குநர்கள்", "mode.gallery": "கேலரி", "mode.workflows": "பணிப்பாய்வுகள்", "mode.learn": "கற்றல்", "mode.study": "படிப்பு", "mode.docs": "ஆவணங்கள்", "mode.schedules": "அட்டவணைகள்", "mode.control": "கட்டுப்பாட்டு மையம்",
  "sb.newChat": "புதிய அரட்டை", "sb.search": "அரட்டைகளைத் தேடு…", "sb.settings": "⚙ அமைப்புகள், நினைவகம் & கீகள்", "sb.signIn": "👤 உங்கள் பெயரை உள்ளிடுங்கள்", "sb.signOut": "வெளியேறு", "sb.projects": "திட்டங்கள்",
  ...
  "login.title": "Aetheris-க்கு வரவேற்கிறோம்", "login.sub": "தொடர உங்கள் பெயரை உள்ளிடுங்கள்.", "login.google": "Google மூலம் தொடரவும்", "login.github": "GitHub மூலம் தொடரவும்",
  "login.email": "மின்னஞ்சல்", "login.phone": "தொலைபேசி", "login.sendEmail": "மின்னஞ்சலில் குறியீடு அனுப்பு", "login.sendSms": "SMS-இல் குறியீடு அனுப்பு", "login.sending": "அனுப்புகிறது…", "login.code": "6 இலக்க குறியீடு", "login.name": "உங்கள் பெயர் (விருப்பம்)", "login.signIn": "உள்நுழை", "login.verifying": "சரிபார்க்கிறது…", "login.guest": "விருந்தினராகத் தொடரவும் →", "login.required": "உங்கள் கதாபாத்திரங்கள், அரட்டைகள் மற்றும் கணக்குத் தரவைத் தனிப்பட்டதாக வைத்திருக்க உள்நுழைவு அவசியம்.", "login.or": "அல்லது", "login.orGuest": "அல்லது விருந்தினராகத் தொடரவும்", "login.guestPrompt": "உங்களை என்ன பெயரில் அழைக்கலாம்?", "login.guestPlaceholder": "உங்கள் பெயர்", "login.continueGuest": "விருந்தினராகத் தொடரவும்", "login.starting": "தொடங்குகிறது…", "login.guestNote": "விருந்தினர் தரவு இந்த உலாவியில் மட்டுமே இருக்கும்.", "login.change": "மாற்று",
...
const hi: Partial<Record<Key, string>> = {
  "mode.chat": "चैट", "mode.characters": "पात्र", "mode.agents": "एजेंट", "mode.factory": "कोडिंग फ़ैक्टरी", "mode.studio": "स्टूडियो", "mode.apps": "ऐप्स", "mode.providers": "प्रोवाइडर", "mode.gallery": "गैलरी", "mode.workflows": "वर्कफ़्लो", "mode.learn": "सीखें", "mode.study": "अध्ययन", "mode.docs": "दस्तावेज़", "mode.schedules": "शेड्यूल", "mode.control": "कंट्रोल सेंटर",
  "sb.newChat": "नई चैट", "sb.search": "चैट खोजें…", "sb.settings": "⚙ सेटिंग्स, मेमोरी और कुंजियाँ", "sb.signIn": "👤 अपना नाम दर्ज करें", "sb.signOut": "साइन आउट", "sb.projects": "प्रोजेक्ट",
  ...
  "login.title": "Aetheris में आपका स्वागत है", "login.sub": "जारी रखने के लिए अपना नाम दर्ज करें।", "login.google": "Google से जारी रखें", "login.github": "GitHub से जारी रखें",
  "login.email": "ईमेल", "login.phone": "फ़ोन", "login.sendEmail": "ईमेल से कोड भेजें", "login.sendSms": "SMS से कोड भेजें", "login.sending": "भेजा जा रहा है…", "login.code": "6 अंकों का कोड", "login.name": "आपका नाम (वैकल्पिक)", "login.signIn": "साइन इन", "login.verifying": "जाँच हो रही है…", "login.guest": "अतिथि के रूप में जारी रखें →", "login.required": "आपके पात्रों, चैट और खाते के डेटा को निजी रखने के लिए साइन इन करना आवश्यक है।", "login.or": "या", "login.orGuest": "या अतिथि के रूप में जारी रखें", "login.guestPrompt": "हम आपको किस नाम से बुलाएँ?", "login.guestPlaceholder": "आपका नाम", "login.continueGuest": "अतिथि के रूप में जारी रखें", "login.starting": "शुरू हो रहा है…", "login.guestNote": "अतिथि डेटा केवल इसी ब्राउज़र में रहता है।", "login.change": "बदलें",
