...
const en = {
  "mode.chat": "Chat", "mode.agents": "Agents", "mode.factory": "Coding Factory", "mode.studio": "Studio", "mode.apps": "Apps", "mode.providers": "Providers", "mode.gallery": "Gallery",
...
const ta: Partial<Record<Key, string>> = {
  "mode.chat": "அரட்டை", "mode.agents": "ஏஜென்ட்கள்", "mode.factory": "கோடிங் தொழிற்சாலை", "mode.studio": "ஸ்டுடியோ", "mode.apps": "ஆப்ஸ்", "mode.providers": "வழங்குநர்கள்", "mode.gallery": "கேலரி",
...
const hi: Partial<Record<Key, string>> = {
  "mode.chat": "चैट", "mode.agents": "एजेंट", "mode.factory": "कोडिंग फ़ैक्टरी", "mode.studio": "स्टूडियो", "mode.apps": "ऐप्स", "mode.providers": "प्रोवाइडर", "mode.gallery": "गैलरी",
